...
import com.zetavision.panda.ums.BaoyangActivity;
...
public class BaoyangFragment extends CaptureFragment {
    ...
    public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {
        ...
        if(!rawResult.getText().equals("")) {
            Intent intent = new Intent(getContext(), BaoyangActivity.class);
