...
final class CameraConfigurationManager {
  ...
  void setDesiredCameraParameters(OpenCamera camera, boolean safeMode) {
    ...
    CameraConfigurationUtils.setFocus(parameters, IS_AUTO_FOCUS, IS_DISABLE_CONTINUOUS_FOCUS, safeMode);
    ...
    if (!safeMode) {
      ...
      if (!IS_DISABLE_BARCODE_SCENE_MODE) {
        CameraConfigurationUtils.setBarcodeSceneMode(parameters);
      }

      if (!IS_DISABLE_METERING) {
  ...
  private void initializeTorch(Camera.Parameters parameters, SharedPreferences prefs, boolean safeMode) {
    doSetTorch(parameters, IS_FRONT_LIGHT_MODE_ON, safeMode);
  }

  private void doSetTorch(Camera.Parameters parameters, boolean newSetting, boolean safeMode) {
    CameraConfigurationUtils.setTorch(parameters, newSetting);
    SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
    if (!safeMode && !IS_DISABLE_EXPOSURE) {
